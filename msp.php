...
<table width="1161" height="305" border="0">
  ...
  <tr>
    <td height="223">&nbsp;</td>
    <td><p class="style6">MONEY SAVING PASS(MSP)</p>
      <p><img src="http://www.carnation.in/uploads/offer/5/16-msp.jpg" alt="6" width="436" height="231"/></p>
      <p><span class="style11">Enjoy discounts for a year on various car services with Money  Saving Pass at Rs. 399 only</span> <br />
MSP allows a vehicle  owner to avail our services multiple times and enjoy huge discount on multiple  services.<br />
<br />
1. For 1st Paid  Service 50% Off on Labor Charges<br />
2. For other Service  20% Off on Labor Charges<br />
3. FREE Washing and  Alignment<br />
<strong>Terms and Condition :</strong> <br />
1. Taxes Extra and  offer is non transferable<br />
2. Oil, Filter and other consumables to be paid<br />
    ...
    <td><table width="291" height="207" border="1">
      ...
      <tr>
        <td><form id="form1" name="form1" method="post" action="">
          ...
          <p>
            <label>Email<br />
            <input type="text" name="tmail" id="tmail" />
            </label>
          </p>
          <p>
            <label>Mobile<br />
            <input type="text" name="tmobile" id="tmobile" />
            </label>
          </p>
          <p>
            <label>Select Make
            <select name="lmake2" id="lmake2">
                                    </select>
            </label>
            <label>Select Model
          ...
          <p>
            ...
            I accept & understand that Carnation.in or its partners may call/ send text messages to this number, in order to service my requests or send me reminders.
          <p><input type="submit" id="submit_btn" class="btn btn-primary" value="Apply Now" >
