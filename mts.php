...
<table width="1161" height="305" border="0">
  ...
  <tr>
    <td height="223">&nbsp;</td>
    <td><p class="style6">MID TERM SERVICE(MTS)</p>
      <p class="style6"><img src="15-mts.jpg" alt="5" width="570" height="313" /></p>
      <p><span class="style12">Get  our Mid Term Service (MTS) at Rs.399 only</span> <br />
        Keep  your car away from unnecessary annoyance like niggling, rattling from  inside/outside the car, abnormal behavior by the car and untimely appearance of  strange warning light on the dashboard etc.<br />
  <strong>Terms  and Condition :</strong> <br />
      ...
      5. Pick &amp; Drop is not part of the offer but the discretion of Unit Head. </p>
      <p class="style6">&nbsp;</p>
      <p>&nbsp;</p>    </td>
