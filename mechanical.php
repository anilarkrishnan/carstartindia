...
<table width="1161" height="305" border="0">
  ...
  <tr>
    <td height="223">&nbsp;</td>
    <td><h1 class="style12">3M Mechanical Care (Exclusive Offer)</h1>
    <p class="style6">&nbsp;</p>
      <p class="style6"><img src="http://www.carnation.in/uploads/offer/5/17-11.jpg" alt="7" width="504" height="306"/></p>
      <p class="style6">&nbsp;</p>
      <p>Protecting your car from  unnecessary hassles is important for preventing needless headache. Get complete  peace of mind with our 3M Mechanical Care that provides complete car protection  for electrical, brake and other parts at just Rs.600.</p>
      <p class="style6">&nbsp;</p>
      <p>&nbsp;</p>    </td>
